...
PROCEDURE piAcao:
    ...
    DO TRANS ON ERROR UNDO, LEAVE
             ...
             ON QUIT  UNDO, LEAVE:
              ...
              /*  
           CREATE ttbPedido.
           ASSIGN ttbPedido.id          =  oPayload:getInteger("id")  WHEN  oPayload:has("id")
                  ttbPedido.nome        =  oPayload:getCharacter("nome")  WHEN  oPayload:has("nome")
                  ttbPedido.telefone    =  oPayload:getCharacter("telefone")  WHEN  oPayload:has("telefone")
                  ttbPedido.dtCriacao   =  oPayload:getDate("dtCriacao")  WHEN  oPayload:has("dtCriacao")
                  ttbPedido.ativo       =  oPayload:getLogical("ativo")  WHEN  oPayload:has("ativo")             
                  ttbPedido.situacao    =  oPayload:getInteger("situacao")  WHEN  oPayload:has("situacao") .
                  
         
          
          FIND  tbPedido WHERE tbPedido.id  = ttbPedido.id EXCLUSIVE-LOCK NO-ERROR.
          ...
          DO:
               ...
               DO:
                   CREATE tbPedido.
                   ASSIGN tbPedido.id          = ttbPedido.id    
                          tbPedido.nome        = ttbPedido.nome      
                          tbPedido.telefone    = ttbPedido.telefone  
                          tbPedido.dtCriacao   = ttbPedido.dtCriacao
                          tbPedido.ativo       = ttbPedido.ativo     
                          tbPedido.situacao    =  ttbPedido.situacao  .     
          ...
          DO:
              IF NOT AVAIL tbPedido THEN
               ...
               DO:              
                   ...
                   ASSIGN tbPedido.nome        = ttbPedido.nome      
                          tbPedido.telefone    = ttbPedido.telefone  
                          tbPedido.dtCriacao   = ttbPedido.dtCriacao 
                          tbPedido.ativo       = ttbPedido.ativo    
                          tbPedido.situacao    = ttbPedido.situacao .
